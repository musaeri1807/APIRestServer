                        ...
                        <div class="form mx-auto">
                            ...
                            <form method="post" class="form-horizontal">
                                <div class="form-group first">
                                    ...
                                    <input type="text" name="txt_username" class="form-control" placeholder="Email Address" />
                                </div>
                                ...
                                <input type="submit" name="btn_login" class="btn btn-primary" value="Reset Password">
                            </form>
